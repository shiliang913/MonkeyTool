...
public class MyJList extends JFrame { 
	...
	public MyJList() {
		...
		InstallData[] options = { new InstallData("Program executable", 118), 
				...
				new InstallData("Source code", 133),new InstallData("Tools and converters", 83), new InstallData("Tools and converters", 83), new InstallData("Tools and converters", 83), new InstallData("Tools and converters", 83), new InstallData("Tools and converters", 83), new InstallData("Tools and converters", 83),  }; 
